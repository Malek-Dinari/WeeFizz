...
const SizeSelectionScreen = () => {
  ...
  const isButtonEnabled = hunit === 'cm';
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        style={[styles.nextButton, { opacity: isButtonEnabled? 1 : 0.5 }]} // Set opacity based on button state
...
const styles = StyleSheet.create({
  ...
  nextButton: { 
    ...
    bottom: 20, 
    alignSelf: 'center',
    opacity: 0.5, // Default opacity for disabled state
  },
  nextButtonImage: { 
    width: 334, 
    height: 50 
